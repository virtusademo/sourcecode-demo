...
<body>
<marquee><h1> <font color="red">Welcome to Virtusa DevOps Demo....!!!</font></h1></marquee>
<h3>Continuous Integration and Continuous Deployment Pipeline....!</h3>
<h3>My Counter : ${counter}</h3>	
<table width="960" border="0" cellspacing="10" cellpadding="0" align="center">
  <tr align="justify">
    <td valign="top" width="220px">
    	<img src="hioxindia-pharmacy_08.jpg" alt="" border="0" /> <br /> 
      <h1>Pharmaceutist</h1>
    ...
    <td valign="top">
    	<img src="hioxindia-pharmacy_12.jpg" alt="" border="0" />
        <h1>Tablets</h1>
      <p>This high quality free pharmaceutical company   is built using XHTML and CSS..</p>
        <p align="right"><a href="#" class="more">View More</a></p>
    </td>
    <td valign="top">
    	<img src="hioxindia-pharmacy_14.jpg" alt="" border="0" />
        <h1>Medical Shop</h1>
...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  <tr align="justify">
    <td width="200" valign="top">
    	<img src="hioxindia-pharmacy_19.jpg" alt="" border="0" />    </td>
